    ...
    return(
        <div className='flex flex-col mx-15 my-15'>
            <div className='flex gap-1 font-serif'>
                <UserRound size={24} className='font-[500] text-accent dark:text-dark-accent' />
                <h1 className='text-[20px] text-accent dark:text-dark-accent font-[500]'>About Me</h1>
            </div>
            ...
            <div className='homeskillbox flex justify-between bg-glass shadow-glass-shadow dark:shadow-dark-glass-shadow dark:bg-dark-glass border border-accent dark:border-dark-accent rounded-md pt-10 pb-8 max-w-[640px] mt-10'>
            ...
            {/*For Skills and all*/}
            <div className='flex gap-10 px-10 py-10 shadow-glass-shadow dark:shadow-dark-glass-shadow bg-glass dark:bg-dark-glass border border-accent dark:border-dark-accent rounded-md mt-10'>
                <div className='flex flex-wrap gap-5 flex-col font-serif'>
                    ...
                    <button onClick={() => router.push('/contacts')} className="shadow-glass-shadow dark:shadow-dark-glass-shadow group gap-[20px] max-w-[50%] mt-10 flex items-center gap-2 rounded-md bg-accent dark:bg-dark-accent px-6 py-3 text-sm font-medium text-text-primary dark:text-dark-text-primary transition-transform duration-200 hover:scale-[1.03] hover:bg-accent-dark dark:hover:bg-dark-accent-dark active:scale-95 cursor-pointer">
                        Let's Connect
                ...
                <div className='grid grid-cols-3 gap-5 font-serif'>
                    <div className='flex flex-col gap-2 shadow-glass-shadow dark:shadow-dark-glass-shadow border border-accent dark:border-dark-accent rounded-md px-5 py-5'>
            ...
            <div className='flex flex-col mt-10 gap-6 shadow-glass-shadow dark:shadow-dark-glass-shadow bg-glass dark:bg-dark-glass border border-accent dark:border-dark-accent rounded-md px-10 py-10'>
                ...
                <div className='grid grid-cols-5 gap-10'>
                    <div className='flex flex-col gap-4 px-4 py-4 shadow-glass-shadow dark:shadow-dark-glass-shadow justify-center items-center border border-accent dark:border-dark-accent rounded-md'>
                    ...
                    <button onClick={() => {router.push('/skill')}} className='flex flex-col gap-4 px-4 py-4 shadow-glass-shadow dark:shadow-dark-glass-shadow justify-center items-center border border-accent dark:border-dark-accent rounded-md transition-transform ease-in duration-200 cursor-pointer hover:scale-[1.05]'>
