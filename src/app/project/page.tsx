...
export default function Project(){
    ...
    return(
        ...
        <div className="flex flex-col mx-15 my-15">
            <div className="flex">
                <div className="flex-col flex">
                    ...
                    <div className="flex font-serif mt-5">
                        <a href="https://github.com/ishitsengupta" target="_blank" className="flex gap-3 border border-accent dark:border-dark-accent bg-glass dark:bg-dark-glass rounded-md px-4 py-2 hover:scale-[1.05] cursor-pointer transition-all hover:bg-white/20 duration-200 ease-in">
                            <h1>View Github</h1>
                            <FaGithub size={23} />
                        </a>
                    </div>
                ...
                <div className="bg-glass dark:bg-dark-glass grid grid-cols-1 ml-auto mr-0 mt-0 mb-auto border border-accent dark:border-dark-accent px-6 py-6 rounded-md justify-between items-center gap-6">
                    <div className="flex">
            ...
            <div className="flex mx-0 mt-10 border border-accent dark:border-dark-accent rounded-md justify-between py-5 px-15">
                <button onClick={() => setActive("All Projects")} className={`font-serif text-[15px] cursor-pointer flex gap-1 items-center mr-7 ml-8 pt-3 pb-3 px-3 rounded-md transition-all duration-200 ${active === "All Projects"? "bg-glass dark:bg-dark-glass border border-accent dark:border-dark-accent dark:text-dark-text-primary text-text-primary scale-105 shadow-md" : "text-text-secondary dark:text-dark-text-secondary dark:hover:bg-dark-glass hover:bg-glass hover:text-text-primary dark:hover:text-dark-text-primary"}`}> All Projects </button>
                <div className="border-l-[0.5px] border:text-secondary dark:border-dark-text-secondary" />
                <button onClick={() => setActive("Featured")} className={`font-serif text-[15px] cursor-pointer flex gap-1 items-center mr-7 ml-8 pt-3 pb-3 px-3 rounded-md transition-all duration-200 ${active === "Featured"? "bg-glass dark:bg-dark-glass border border-accent dark:border-dark-accent dark:text-dark-text-primary text-text-primary scale-105 shadow-md" : "text-text-secondary dark:text-dark-text-secondary dark:hover:bg-dark-glass hover:bg-glass hover:text-text-primary dark:hover:text-dark-text-primary"}`}> Featured </button>
                <div className="border-l-[0.5px] border:text-secondary dark:border-dark-text-secondary" />
                <button onClick={() => setActive("Full Stack")} className={`font-serif text-[15px] cursor-pointer flex gap-1 items-center mr-7 ml-8 pt-3 pb-3 px-3 rounded-md transition-all duration-200 ${active === "Full Stack"? "bg-glass dark:bg-dark-glass border border-accent dark:border-dark-accent dark:text-dark-text-primary text-text-primary scale-105 shadow-md" : "text-text-secondary dark:text-dark-text-secondary dark:hover:bg-dark-glass hover:bg-glass hover:text-text-primary dark:hover:text-dark-text-primary"}`}> Full Stack </button>
                <div className="border-l-[0.5px] border:text-secondary dark:border-dark-text-secondary" />
                <button onClick={() => setActive("Open Source")} className={`font-serif text-[15px] cursor-pointer flex gap-1 items-center mr-7 ml-8 pt-3 pb-3 px-3 rounded-md transition-all duration-200 ${active === "Open Source"? "bg-glass dark:bg-dark-glass border border-accent dark:border-dark-accent dark:text-dark-text-primary text-text-primary scale-105 shadow-md" : "text-text-secondary dark:text-dark-text-secondary dark:hover:bg-dark-glass hover:bg-glass hover:text-text-primary dark:hover:text-dark-text-primary"}`}> Open Source </button>
                <div className="border-l-[0.5px] border:text-secondary dark:border-dark-text-secondary" />
                <button onClick={() => setActive("Others")} className={`font-serif text-[15px] cursor-pointer flex gap-1 items-center mr-7 ml-8 pt-3 pb-3 px-3 rounded-md transition-all duration-200 ${active === "Others"? "bg-glass dark:bg-dark-glass border border-accent dark:border-dark-accent dark:text-dark-text-primary text-text-primary scale-105 shadow-md" : "text-text-secondary dark:text-dark-text-secondary dark:hover:bg-dark-glass hover:bg-glass hover:text-text-primary dark:hover:text-dark-text-primary"}`}> Others </button>
            </div>
            {emptystate && (
