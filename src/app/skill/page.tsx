        ...
        <div className="flex flex-col">
            <div className="flex flex-row">
                <div className="flex flex-col mx-15 my-15">
                    <p className="font-serif text-accent dark:text-dark-accent text-[20px] font-[600] mb-[5px]">My Skills</p>
                ...
                <div className="homeskillbox overflow-hidden shadow-glass-shadow dark:shadow-dark-glass-shadow flex flex-wrap items-center justify-between rounded-md dark:border dark:border-dark-accent border border-accent dark:bg-dark-glass bg-glass p-4 backdrop-blur-[6px] my-15 mr-15 ml-auto">
            ...
            <div className="flex flex-col mt-5 mb-15">
                <div className="homeskillbox flex justify-center gap-10 mx-15 pt-6 pb-5 px-10 shadow-glass-shadow dark:shadow-dark-glass-shadow border border-accent dark:border-dark-accent rounded-md mb-5">
                    {tabs.map((tab, i) => {
                        const Icon = tab.icon
