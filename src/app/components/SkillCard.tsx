...
export default function SkillCard({icon, imageAlt, title, desc, level, num, prof, exp, about, color, note}:cardprops){
  ...
  const isDark = resolvedTheme === 'dark'
    return(
        <div className="relative shadow-glass-shadow dark:shadow-dark-glass-shadow w-full max-w-[680px] rounded-md dark:border dark:border-dark-accent border border-accent p-8 dark:shadow-[0_8px_32px_rgba(0,0,0,0.35)] shadow-[0_8px_32px_rgba(26,26,24,0.05)]" style={{
  background: isDark
