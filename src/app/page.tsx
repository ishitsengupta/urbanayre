...
export default function Home(){
    ...
    return(
        <div className='flex flex-col'>
            ...
            <div className="flex flex-col px-5 sm:px-8 md:px-15 py-5 gap-[15px]">
                ...
                <h1 className="introtext text-[36px] sm:text-[48px] md:text-[64px]">Hi, I&apos;m <span className="text-[#c19a5b] dark:text-[#5b7ec1]">Ishit</span> <p>Full Stack Developer</p></h1>
                <p className="introtext1">On a mission to learn many different frameworks and build projects on it</p>
                <div className='flex flex-col sm:flex-row gap-[15px] sm:gap-[20px] mt-[10px]'>
                    <button onClick={() => router.push('/project')} className="shadow-glass-shadow dark:shadow-dark-glass-shadow group flex items-center justify-center gap-2 rounded-lg bg-[#c19a5b] dark:bg-[#5b7ec1] px-6 py-3 text-sm font-medium text-text-primary dark:text-[#f2f0eb] transition-transform duration-200 hover:scale-[1.03] hover:bg-[#c19a5b] dark:hover:bg-[#3e6ba4] active:scale-95 cursor-pointer">
                        View My Work
                        <ArrowRight className="h-4 w-4 transition-transform duration-200 group-hover:translate-x-1" />
                    </button>
                    <button onClick={() => router.push('/contacts')} className="shadow-glass-shadow dark:shadow-dark-glass-shadow flex items-center justify-center gap-2 rounded-lg dark:border dark:border-dark-text-primary border border-text-primary dark:bg-slate/5 bg-white/5  px-6 py-3 text-sm font-medium dark:text-dark-text-primary text-text-primary transition-all duration-200 dark:hover:bg-slate/10 hover:bg-white/10 hover:scale-[1.03] cursor-pointer active:scale-95">
                        Contact Me
            ...
            <div className="overflow-hidden items-center rounded-md shadow-glass-shadow dark:shadow-dark-glass-shadow justify-center dark:bg-dark-glass bg-glass mx-5 sm:mx-8 md:mx-15 mt-[50px] mb-[20px] max-w-full max-h-full">
      

      <div className="homeskillbox overflow-hidden grid grid-cols-2 sm:flex sm:flex-wrap items-center justify-between rounded-md border dark:border-dark-accent  border-accent dark:bg-dark-glass bg-glass p-4 backdrop-blur-[6px]">
        {skills.map(({ icon: Icon, title, desc }, i) => (
          <div
            key={title}
            className={`overflow-hidden flex items-center gap-3 px-4 py-2 ${
              i !== 0 ? "sm:border-l border-accent-dark dark:border-l dark:border-dark-accent-dark" : ""
            }`}
          >
            <div className="overflow-hidden flex h-10 w-10 shrink-0 items-center justify-center rounded-md dark:bg-dark-glass bg-glass dark:border dark:border-dark-accent border border-accent">
    ...
    <div className='flex flex-col shadow-glass-shadow dark:shadow-dark-glass-shadow dark:bg-dark-glass bg-glass rounded-md dark:border-[1px] border-[1px] dark:border-dark-accent border-accent mb-[50px] mt-[50px] mx-5 sm:mx-8 md:mx-15 overflow-hidden max-w-full max-h-full'>
        <div className='flex flex-col mx-5 sm:mx-8 my-8 overflow-hidden'>
            <p className='text-[15px] font-[500] dark:text-dark-accent-dark text-accent-dark tracking-[1px] font-serif italic mb-2'>Skills</p>
            <h1 className='text-[26px] sm:text-[35px] font-[700] font-serif tracking-[1px] mb-1'><span className='dark:text-dark-accent text-accent'>Tech</span> Stack I Work With</h1>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mx-5 sm:mx-8 my-8 gap-[15px]'>
    ...
    <div className="flex flex-col mb-[50px] mx-5 sm:mx-8 md:mx-15 shadow-glass-shadow dark:shadow-dark-glass-shadow border border-accent dark:border-dark-accent rounded-md px-5 sm:px-8 py-8">
      ...
      <h1 className='text-[26px] sm:text-[35px] font-[700] font-serif tracking-[1px]'><span className='dark:text-dark-accent text-accent'>Latest</span> Projects Built by Me</h1>
